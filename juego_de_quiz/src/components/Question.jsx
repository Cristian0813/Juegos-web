	...
	return (
		<>
			{activeResults ? (
				...
				<div className='flex flex-col justify-between shadow-md shadow-slate-300 w-full h-full p-4'>
					...
					<div className='grid grid-cols-2 gap-5'>
						...
						{answersRandom.map((answer, index) => (
							<button
								className={`border p-5 rounded-lg flex justify-center items-center hover:scale-105 ${selectAnswerIndex !== null &&
